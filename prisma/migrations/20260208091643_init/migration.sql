-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('STYLIST', 'ADMIN');
...
-- CreateIndex
CREATE INDEX "subscriptions_stylist_id_idx" ON "subscriptions"("stylist_id");
...
-- AddForeignKey
ALTER TABLE "subscriptions" ADD CONSTRAINT "subscriptions_stylist_id_fkey" FOREIGN KEY ("stylist_id") REFERENCES "stylists"("id") ON DELETE CASCADE ON UPDATE CASCADE;
